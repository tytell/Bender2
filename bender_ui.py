...
class Ui_BenderWindow(object):
    def setupUi(self, BenderWindow):
        ...
        self.yAxisCombo = QtGui.QComboBox(self.layoutWidget)
        self.yAxisCombo.setObjectName(_fromUtf8("yAxisCombo"))
        self.yAxisCombo.addItem(_fromUtf8(""))
        self.yAxisCombo.addItem(_fromUtf8(""))
        self.yAxisCombo.addItem(_fromUtf8(""))
        self.gridLayout_2.addWidget(self.yAxisCombo, 1, 2, 1, 1)
        ...
        self.xAxisCombo = QtGui.QComboBox(self.layoutWidget)
        self.xAxisCombo.setObjectName(_fromUtf8("xAxisCombo"))
        self.xAxisCombo.addItem(_fromUtf8(""))
        self.xAxisCombo.addItem(_fromUtf8(""))
        self.xAxisCombo.addItem(_fromUtf8(""))
        self.gridLayout_2.addWidget(self.xAxisCombo, 1, 1, 1, 1)
...
"{a}=Amplitude", None))
        ...
        self.yAxisCombo.setItemText(0, _translate("BenderWindow", "Raw data", None))
        self.yAxisCombo.setItemText(1, _translate("BenderWindow", "Raster plot", None))
        self.yAxisCombo.setItemText(2, _translate("BenderWindow", "Phase", None))
        ...
        self.xAxisCombo.setItemText(0, _translate("BenderWindow", "Time", None))
        self.xAxisCombo.setItemText(1, _translate("BenderWindow", "Phase", None))
        self.xAxisCombo.setItemText(2, _translate("BenderWindow", "Cycles", None))
        self.label_4.setText(_translate("BenderWindow", "X axis", None))
