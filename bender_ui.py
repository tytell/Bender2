...
"{a}=Amplitude", None))
        ...
        self.plotYBox.setItemText(2, _translate("BenderWindow", "Body torque from X torque", None))
        self.plotYBox.setItemText(3, _translate("BenderWindow", "Body torque from Y force", None))
        self.plotYBox.setItemText(4, _translate("BenderWindow", "X force", None))
